...
Silahkan @${m.mentionedJid[0].split`@`[0]} untuk ketik terima/tolak`
	    ...
	    case 'donasi': case 'sewabot': case 'sewa': case 'buypremium': case 'donate': {
                hisoka.sendMessage(m.chat, { image: { url: 'https://telegra.ph/file/74fd634010128be37972c.jpg' }, caption: `*Hai Kak ${m.pushName}*\n\n Bot Rental Prices\n⭔ 13k Per Group via E-Walet 1 Month\n⭔ 18k via pulsa 1 Month\n\n Premium Price Bot\n⭔ 8k per User 1 bulan\n\nPayment can be via Paypal/link aja/pulsa\n\nFor more details, you can chat with the owner\nhttps://wa.me/6285711324080 (Owner)\n\nDonate For Me : \n\n⭔ Paypal : https://www.paypal.me/Cakhaho\n⭔ Saweria : https://saweria.co/Henzz` }, { quoted: m })
            }
            break
            case 'sc': {
                m.reply('Script : https://github.com/henzz4368/amura-md\n\n Dont Forget Give Star\n\nDonate : 6285711324080 (Link Aja)\nSaweria : https://saweria.co/Henzz\nPaypal : https://www.paypal.me/Cakhaho\n\n Dont Forget Donate')
            }
            break
            case 'chat': {
...
let teks = `══✪〘 *👥 Tag All* 〙✪══
 ...
 ➲ *Pesan : ${q ? q : 'kosong'}*\n\n`
	    ...
	    break
            ...
            if (!text) throw `this is a WhatsApp Bot named amura md`
	    ...
	    break
	       case 'attp': case 'ttp': {
           if (!text) throw `Example : ${prefix + command} text`
           await hisoka.sendMedia(m.chat, `https://xteam.xyz/${command}?file&text=${text}`, 'amura', 'multidevice', m, {asSticker: true})
...
⭔ Url : ${anu.url}`
	    ...
	    case 'nomerhoki': case 'nomorhoki': {
            ...
            case 'ramalanjodoh': case 'ramaljodoh': {
                if (!text) throw `Example : ${prefix + command} Henzz, 7, 7, 2005, Novia, 16, 11, 2004`
            ...
            break
            case 'artinama': {
                if (!text) throw `Example : ${prefix + command} HenzzXD`
            ...
            case 'kecocokannama': case 'cocoknama': {
                if (!text) throw `Example : ${prefix + command} Henzz, 7, 7, 2005`
            ...
            case 'kecocokanpasangan': case 'cocokpasangan': case 'pasangan': {
                if (!text) throw `Example : ${prefix + command} Henzz|Novia`
            ...
            break
            case 'fengshui': {
                if (!text) throw `Example : ${prefix + command} Henzz, 1, 2005\n\nNote : ${prefix + command} Nama, gender, tahun lahir\nGender : 1 untuk laki-laki & 2 untuk perempuan`
            ...
            break
            case 'peruntungan': {
                if (!text) throw `Example : ${prefix + command} Henzz, 7, 7, 2005, 2022\n\nNote : ${prefix + command} Nama, tanggal lahir, bulan lahir, tahun lahir, untuk tahun`
